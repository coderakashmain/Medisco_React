      ...
      <div className="container">
        ...
        >
          <div className="lg:w-1/2 w-full">
            <h2
              className="xxl:text-5xl xl:text-[42px] sm:text-4xl text-2xxl font-bold font-sora text-white sm:leading-44 leading-34 xl:leading-62 max-lg:text-center"
            >
              Stay Updated With Healthcare Savings & Offers.
            </h2>
          </div>
          <div className="subscribe-form max-lg:mx-auto max-sm:w-full">
            <form
              className="relative w-full dzSubscribe"
              action="https://madula.dexignlab.com/tailwind/demo/assets/script/mailchamp.php"
              method="post"
            >
        ...
        <div className="lg:py-100 md:py-80 py-60">
          <div className="grid grid-cols-12 gap-25">
            ...
            <div className="lg:col-span-3 sm:col-span-6 col-span-12">
              <div
                className="lg:border-l lg:border-[#D8D8D8] xxl:pl-80 xl:pl-50 sm:pl-40 xxl:ml-40 sm:ml-20"
              >
                <h5
                  className="font-bold xxl:text-2xxl text-xxl capitalize pb-18 font-sora text-secondary"
                >
                  Link
                </h5>
                <ul>
            ...
            <div className="lg:col-span-3 sm:col-span-6 col-span-12">
              <div
                className="lg:border-l lg:border-[#D8D8D8] xxl:pl-80 xl:pl-50 lg:pl-40 xxl:ml-40 lg:ml-20"
              >
                <h5
                  className="font-bold xxl:text-2xxl text-xxl capitalize pb-18 font-sora text-secondary"
                >
            ...
            <div className="lg:col-span-3 sm:col-span-6 col-span-12">
              <div
                className="lg:border-l lg:border-[#D8D8D8] xxl:pl-70 xl:pl-40 sm:pl-30 xxl:ml-40 sm:ml-20"
              >
                <h5
                  className="font-bold xxl:text-2xxl text-xxl capitalize pb-18 font-sora text-secondary"
                >
                ...
                <ul>
                  <li className="pb-16">
                    <h6
                      className="pb-6 capitalize font-urbanist text-secondary text-base font-medium leading-[1.2] flex items-center"
                    >
                      <i className="mr-5">
                        <svg
                          width="10"
